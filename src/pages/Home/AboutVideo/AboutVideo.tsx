        ...
        <div className="first_block_content">
          ...
          <div className="tex_content">
            <span className="tex_content_header">
              Безкоштовні відеоконференцій
            </span>
            <h1 className="tex_content_title">Спілкуйтеся з клієнтами</h1>
            <span className="tex_content_footer">
              Використовуйте відеодзвінки, щоб установити зв'язок з потенційними
              клієнтами або проводити привабливі відеодзвінки для спілкування з
              будь-якою аудиторією, незалежно від їхнього місця, просто
